...
PORTB, Pin 12 Used for SST25VF3032B Chip Select ---
------------------------------------------------
---------------------------------- ---------------------------------- 12
...
PORTA, Pin 7 May be used as GPIO input ---
------------------------------------------------
---------------------------------- ---------------------------------- 14
...
SPI1 clock CTED5 CTMU External Edge Input 5 RB14 PORTB, Pin 14 ---
------------------------------------------------
---------------------------------- ---------------------------------- 15
...
PORTB, Pin 15 Not available ---
------------------------------------------------
---------------------------------- ---------------------------------- 16
AVSS AVSS Not available off module ---
------------------------------------------------
---------------------------------- ---------------------------------- 17
AVDD AVDD Not available off module ---
------------------------------------------------
---------------------------------- ---------------------------------- 18
\~MCLR \~MCLR, TC2030-NL, pin 1 Not available off module ---
------------------------------------------------
---------------------------------- ---------------------------------- 19
...
input RB1 PORTB, Pin 1 May be used as GPIO input ---
------------------------------------------------
---------------------------------- ---------------------------------- 23
...
GPIO output --- ------------------------------------------------
---------------------------------- ---------------------------------- 28
VDD VDD Not available off module ---
------------------------------------------------
---------------------------------- ---------------------------------- 29
VSS VSS Not available off module ---
------------------------------------------------
...
available RA8 PORTA, Pin 8 May be used for GPIO input ---
------------------------------------------------
---------------------------------- ---------------------------------- 33
...
be used for CTMU input RA4 PORTA, Pin 4 May be used as GPIO input ---
------------------------------------------------
---------------------------------- ---------------------------------- 35
...
used for GPIO output ---
------------------------------------------------
---------------------------------- ---------------------------------- 38
RPC5/PMA3/RC5 FUNC4 FUNC4, to X3, pin4 RPC5 Peripheral Selection, PORTC,
Pin 5 PMA3 Parallel Master Port Address bit 3 RC5 PORTC, Pin 5 ---
------------------------------------------------
---------------------------------- ---------------------------------- 39
VSS VSS Not available off module ---
------------------------------------------------
...
PORTB, Pin 5 USBID 41 USB OTG ID detect RB5 41 PORTB, Pin 5 ---
------------------------------------------------
---------------------------------- ---------------------------------- 42
...
This configuration will also work with any generic mips-elf GCC past
version 4.6 or so.
...
\#include \<nuttx/spi/spi.h\> \#include \<nuttx/analog/pga11x.h\>
