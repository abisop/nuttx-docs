...
PIC32MX795F512L Pin Out MEB Connector PICtail Serial Output using the
...
PICtail PIN FUNCTION -------- ----------- 1 3.3V 16 U2RX 18 U2TX 28 GND
...
We will use the labels on the board to identify LEDs. If
