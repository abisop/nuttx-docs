...
`/guides/customboards`{.interpreted-text role="doc"}. And if you wanted
to add own apps, see `/guides/customapps`{.interpreted-text role="doc"}.
...
For details about these files, see `out-of-tree`{.interpreted-text
role="ref"}.
...
time, the build system will teach that you have to implement \"chip.h\"
as following.
...
lpc43xx, etc) or `out-of-tree`{.interpreted-text role="ref"} and retry
to build, the build system will teach that you have to implement some
...
`/applications/nsh/customizing`{.interpreted-text role="doc"} +
+\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\--+\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\--+
\| \|
...
Appendix : out-of-tree code {#out-of-tree}
---------------------------
