...
\[[/component\](]{.title-ref}/component.md)s/nxgraphics/index\` and
application oriented \[[NxWidget\](\`NxWidget.md)s
\</applications/graphics/nxwidgets/index\>]{.title-ref} and the tiny
window manager \[[NxWM \</application\](\`NxWM
\</application.md)s/graphics/nxwm/index\>]{.title-ref}. These are higher
level in the sense that the primary graphical function is to support
windowing and control of tools and toolbars within windows. These
graphics tools often do not meet the needs of developers with very low
end graphics and minimal display requirements.
