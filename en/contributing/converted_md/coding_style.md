C Coding Standard {#coding-standard}
=================
...
**\"Commenting Out\" Large Code Blocks**. Do not use C or C++ comments
...
-   **Single compound statement**. The function body consists of a
